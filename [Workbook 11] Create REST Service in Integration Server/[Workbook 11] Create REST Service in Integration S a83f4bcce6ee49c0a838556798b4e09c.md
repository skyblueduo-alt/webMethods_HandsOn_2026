...
- https://github.com/benoitvallon/100-best-books/blob/master/books.json 파일을 사용, /wm/IS01/books.json 을 생성하고 내용을 입력 & 저장 하거나 books.json 파일을 해당 경로에 업로드 합니다.
...
- getFile 서비스를 사용하여 서버에 위치한 file 데이터를 읽어 서비스를 구성합니다.
  ...
  **loadAs : bytes**
   ...
   ![Untitled](%5BWorkbook%2011%5D%20Create%20REST%20Service%20in%20Integration%20S%20a83f4bcce6ee49c0a838556798b4e09c/rootArray.png)

    ** Output setting**

   ![Untitled](%5BWorkbook%2011%5D%20Create%20REST%20Service%20in%20Integration%20S%20a83f4bcce6ee49c0a838556798b4e09c/rootArray2.png)
